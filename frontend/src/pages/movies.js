...
import { fetchMovieDetails, fetchMovieTrailer, fetchMovieCast } from '@/utils/tmdb';
...
const MoviesGrid = ({ movies }) => (
  <div className="bg-white p-8">
    <h3 className="text-1xl h-10 font-medium text-gray-600 underline underline-offset-8">Movies List</h3>
